...
wage employment opportunities. The dataset used for this analysis encompasses many 
parameters, including the number of job cards issued, the workforce engaged, budget allocation, work 
completion statistics, and much more. Through data analytics techniques, we aim to 
...
- Number of Completed Works: The count of works that have been completed.
...
### Dashboard
#### 1-Overview Report
- The count-issued job cards are 156M.
- The active job cards are 97M
- The total number of completed works is 4M
- Total expenditure is INR 5.47M 
- The bar chart shows the count of job cards issued by state, with Uttar Pradesh (668k) and Bihar (429k) having the highest number of job cards.
  
<img width="617" alt="NREGA Analysis" src="https://github.com/user-attachments/assets/018cf03b-1498-4da3-aeb8-af2b21453cbc">

#### 2-Employment Analysis Report
- Total Register Workers: 269M
- Total Active Workers: 175M
- Scheduled Caste (SC) workers: 35M
- Scheduled Tribe (ST) Active workers: 29M
- Person days of employment provided to women: 979M
- The bar chart counts the Total workers vs Active Workers by state, with West Bengal & Rajasthan having the highest number of workers.
- Pie chart explores the percentage of women, Sc, and ST person-days by state
  
<img width="617" alt="EA" src="https://github.com/user-attachments/assets/f620e330-ed67-4527-9c3b-700e5c87c508">

#### 3-Regional Disparities Report
- Total State: 34
- Total District: 736
- The bar chart counts the average wage rate by state, with Uttar Pradesh at 18k & Manipur 16k having the highest rate.
...
<img width="618" alt="WC" src="https://github.com/user-attachments/assets/c6fcceec-db6d-47bd-9f5f-23eb427dba47">

#### 6-Policy Optimization Report

<img width="617" alt="po" src="https://github.com/user-attachments/assets/6ef94c01-c462-45d9-b8ef-6dbadc954901">
